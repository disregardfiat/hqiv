...
- **HQIV background table:** `hqiv_Ha.txt` (columns: `a`, `H_over_H0`), e.g. extracted from the main HQIV lattice/background generated by `horizon_modes/python/bulk.py` (legacy: `sandbox/hqiv_Ha.txt` from `sandbox/hqiv_background.py`).
